...
#this version of the Agent is not using the SimpleUnitObservationWrapper_1_1 at all; instead is is calling a new function obs_for_units() defined below; 
#it also relies on a multi_agent version of action masks from SimpleUnitDiscreteController, triggered by an extra param in 

#should be the same NN as in ppo_train_1_1.py, with unnecessary features from original example removed
MODEL_WEIGHTS_RELATIVE_PATH = "models/LuxAI_S2-v0__ppo_train_1_1__1__1678646005"

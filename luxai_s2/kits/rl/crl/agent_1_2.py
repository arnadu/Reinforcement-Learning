...
from wrappers import SimpleUnitDiscreteController, SimpleUnitObservationWrapper_1_2

# change this to use weights stored elsewhere
# make sure the model weights are submitted with the other code files
# any files in the logs folder are not necessary. Make sure to exclude the .zip extension here
MODEL_WEIGHTS_RELATIVE_PATH = "models/LuxAI_S2-v0__ppo_train_1_2__1__1678652643"
...
class Agent:
    def __init__(self, player: str, env_cfg: EnvConfig) -> None:
        ...
        self.agent = AgentModel(obs_dim=SimpleUnitObservationWrapper_1_2.SHAPE, action_dim=12)
    ...
    def act(self, step: int, obs, remainingOverageTime: int = 60):
        ...
        obs = SimpleUnitObservationWrapper_1_2.convert_obs(raw_obs, env_cfg=self.env_cfg)
        obs = obs[self.player]

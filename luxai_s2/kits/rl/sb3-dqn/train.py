...
def train(args, env_id, model: DQN):
    eval_env = SubprocVecEnv(
...
def main(args):
    ...
    model = DQN(
        "MlpPolicy",
        env,
        #n_steps=rollout_steps // args.n_envs,  #for DPO
        batch_size=800,
        learning_rate=3e-4,
        policy_kwargs=policy_kwargs,
        verbose=1,
        #n_epochs=2, #for DPO
        #target_kl=0.05, #for PPO not used for DQN
        tau=1.,  #for DQN Polyak update, default hard update=1
        gamma=0.99,

...
from wrappers import SimpleUnitDiscreteController, SimpleUnitObservationWrapper_1, SimpleUnitObservationWrapper_1_1
...
def make_env(env_id, seed, idx, capture_video, run_name, max_episode_steps=1000):
    def thunk():
        ...
        env = SimpleUnitObservationWrapper_1_1(env)

...
from wrappers import SimpleUnitDiscreteController, SimpleUnitObservationWrapper_1_1
...
class Agent:
    def __init__(self, player: str, env_cfg: EnvConfig) -> None:
        ...
        self.agent = AgentModel(obs_dim=SimpleUnitObservationWrapper_1_1.SHAPE, action_dim=12)
    ...
    def act(self, step: int, obs, remainingOverageTime: int = 60):
        ...
        obs = SimpleUnitObservationWrapper_1_1.convert_obs(raw_obs, env_cfg=self.env_cfg)
        obs = obs[self.player]
